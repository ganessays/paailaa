...
@section('body')
                   ...
                   <div class="client_left_area">
                       ...
                       <form action="" method="post">
                           ...
                           <div class="form-group col-md-6">
                               <select name="faculty_id" id="faculty_name" class="form-control">
                           ...
                           <div class="form-group col-md-6">
                               <select name="course_id" id="course_name" class="form-control">
    ...
    <script>
        $('#faculty_name').on('change',function (e) {
            console.log(e);
            var faculty_id = e.target.value;
            $.get('faculty_name?faculty_id=' + faculty_id, function (data) {
                $('#course_name').empty();
                $('#course_name').append('<option>[Choose Course]</option>');
                $.each(data, function (index, zoneObj) {
                    $('#course_name').append('<option value="'+zoneObj.id+'" >'+zoneObj.name+'</option>')
                })
