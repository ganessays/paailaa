...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('admin/list_events')}}"><i class="fa fa-calendar-times-o"></i> Consultancy Listing</a></li>
                <li class="active">Add New Consultancy
                </li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Add New Consultancy</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="uName" class="form-control" placeholder="username" data-validation="required" data-validation-error-msg="User Name Required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" name="com_establised"  class="form-control">
                                            </div>
                                        </div>
                                    </div>
