                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="College_name" name="College_name"  value="{{$CollegeData->College_name}}" data-validation="required" data-validation-error-msg="College name is required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="College_nature_id" id="College_nature_id" data-validation="required" data-validation-error-msg="College nature is required" >
                                                    ...
                                                    @foreach($Nature as $categories)
                                                        <option value="{{$categories->id}}" {{ ($CollegeData->College_nature_id == $categories->id) ? ' selected' : '' }}>{{$categories->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="College_type" id="College_type" data-validation="required" data-validation-error-msg="Status is required" >
                                                    ...
                                                    <option value="General" {{ ($CollegeData->company_type == "General") ? ' selected' : '' }}>General</option>
                                                    <option value="Featured" {{ ($CollegeData->company_type == "Featured") ? ' selected' : '' }}>Featured</option>
                                                    <option value="Sponser" {{ ($CollegeData->company_type == "Sponser") ? ' selected' : '' }}>Sponser</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="College_address" name="College_address" value="{{$CollegeData->College_address}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="name" class="form-control" value="{{$CollegeData->uName}}" data-validation="required" data-validation-error-msg="User Name Required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="status" id="status">
                                                    <option value="2" @if($CollegeData->status == 2) selected @endif>Active</option>
                                                    <option value="1" @if($CollegeData->status == 1) selected @endif>InActive</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
