                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <form action="" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="short" class="form-control" placeholder="">
                                        </td>
                                        <td>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$faculty->short}}</td>
                                    <td>
                                        <a href="{{url('superadmin/add-faculty/faculty_id=').$faculty->id.'/edit'}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                    @endforeach
                                </tbody>
