                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <form action="" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="short" class="form-control" value="{{$faculty->short}}">
                                        </td>
                                        <td>
                                            <textarea id="editor1" name="description" rows="10" cols="40">{{$faculty->description}}</textarea>
                                        </td>
                                        <td>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$faculty->short}}</td>
                                    <td>
                                        <a href="{{url('superadmin/add-faculty/').'/'.$slug=str_slug($faculty->name).'='.$faculty->id.'/edit'}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                    @endforeach
                                </tbody>
